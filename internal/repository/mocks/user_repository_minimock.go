...
//go:generate minimock -i github.com/vbulash/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, info *desc.UserInfo) (i1 int64, err error)
	inspectFuncCreate   func(ctx context.Context, info *desc.UserInfo)
	...
	funcGet          func(ctx context.Context, id int64) (up1 *outermodel.User, err error)
	inspectFuncGet   func(ctx context.Context, id int64)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserRepositoryMockGet

	funcUpdate          func(ctx context.Context, id int64, info *desc.UserInfo) (err error)
	inspectFuncUpdate   func(ctx context.Context, id int64, info *desc.UserInfo)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, info *desc.UserInfo) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) ExpectInfoParam2(info *desc.UserInfo) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, info *desc.UserInfo)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, info *desc.UserInfo) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, info *desc.UserInfo) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, info *desc.UserInfo) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter info, want: %#v, got: %#v%s\n", *mm_want_ptrs.info, mm_got.info, minimock.Diff(*mm_want_ptrs.info, mm_got.info))
			}
...
func (mmGet *mUserRepositoryMockGet) Return(up1 *outermodel.User, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id int64) (up1 *outermodel.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetExpectation) Then(up1 *outermodel.User, err error) *UserRepositoryMock {
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id int64) (up1 *outermodel.User, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, info *desc.UserInfo) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam3(info *desc.UserInfo) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, info *desc.UserInfo)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, info *desc.UserInfo) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, info *desc.UserInfo) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, info *desc.UserInfo) (err error) {
